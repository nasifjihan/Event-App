-- Phase 3 cutover: migrate legacy events into the travel schema.
-- Run this only after travel_schema.sql has been applied successfully.

-- 1. Backfill profiles from auth metadata for existing users.
...
-- 2. Create destination records from distinct event locations.
...
-- 3. Copy legacy events into travel experiences.
...
-- 4. Convert attendees into bookings for the migrated experiences.
